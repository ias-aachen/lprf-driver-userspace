...
=======
	...
	uint8_t txbuf1[] = {
			   ...
			   0xFF, 0xFF, 0xFF, 0xFF,  //31
        	           ...
        	           0xFF, 0xFF, 0xFF, 0xFF,  //39
        	           0xFF, 0xFF, 0xFF, 0xFF,  //40 
>>>>>>> 389723c1c406ca39baef910def27bd9d8ed3299c
};
...
<<<<<<< HEAD
	printf("establish communication with LPRF\n");
=======
	//get chip id
>>>>>>> 389723c1c406ca39baef910def27bd9d8ed3299c
...
<<<<<<< HEAD
	write_reg(&lprf_hw, RG_CHIP_ID_H, 0x1A);    //set chip id back to default
	...
	//===============change to state machine operation=========================
		...
		write_subreg(&lprf_hw, SR_SM_COMMAND, CMD_TX);   //change state to TX __XXX__essential for start/stop
